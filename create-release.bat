...
rd /s /q "%~dp0/dist"
mkdir "%~dp0/dist/OblivionRemastered/Binaries/Win64/OBSE/Plugins"
robocopy "%~dp0/build/windows/x64/releasedbg" "%~dp0/dist/OblivionRemastered/Binaries/Win64/OBSE/Plugins" ue4ss_Loader.pdb ue4ss_Loader.dll
cd "%~dp0/dist"
